...
function Controller() {
    ...
    var handleRotation = function(e) {
        exports.clearGrid();
        cache.width = e.orientation == Ti.UI.LANDSCAPE_LEFT || Ti.UI.LANDSCAPE_RIGHT ? Ti.Platform.displayCaps.getPlatformHeight() : Ti.Platform.displayCaps.getPlatformWidth();
        setTimeout(function() {
